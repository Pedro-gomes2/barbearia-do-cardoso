import { BarChart3, CalendarDays, Ban, Settings, LogOut, Scissors, Wrench, Clock, ShoppingBag, Wallet, Moon, Sun, Users, PieChart } from "lucide-react";
...
const items = [
  ...
  { title: "Análise de Serviços", url: "/admin/analise-servicos", icon: PieChart },
